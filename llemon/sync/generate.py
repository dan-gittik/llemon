...
from llemon.sync.types import NS, FilesArgument, HistoryArgument, RenderArgument, ToolsArgument, Warning
from llemon.utils import Emoji, concat, filtered_dict, now, trim

if TYPE_CHECKING:
    from llemon.sync import LLM, Call, Tool
...
class GenerateStreamResponse(llemon.GenerateResponse):
    ...
    def __aiter__(self) -> Iterator[str]:
