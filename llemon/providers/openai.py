...
from llemon.apis.llm.llm_tokenizer import LLMToken, LLMTokenizer
...
class OpenAI(LLM):
    ...
    async def classify(self, request: ClassifyRequest) -> ClassifyResponse:
        ...
        if request.use_logit_biasing:
            ...
            generate_object_response = await self._generate_object(generate_object_request, GenerateObjectResponse(generate_object_request))
